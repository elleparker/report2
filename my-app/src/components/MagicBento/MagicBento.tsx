    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {(customCards || cardData).map((card, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className="card__title font-semibold text-lg m-0 mb-3 text-yellow-400"
                    >
                      {card.title}
                    </h3>
                    <p
            ...
            return (
              ...
              >
                <div className="card__header flex justify-between gap-3 relative text-white">
                  <span className="card__label text-lg font-bold text-yellow-400">{card.label}</span>
                </div>
                <div className="card__content flex flex-col relative text-white">
                  <h3
